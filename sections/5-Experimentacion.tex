...
\subsection{Análisis del impacto de la \textbf{primera derivada}}
...
\begin{table}[!ht]
    ...
    \resizebox{\textwidth}{!}{\begin{tabular}{|c|cccc|cccc|}
        ...
        \textit{Average} & ~ & ~ & ~ & 61.790 & ~ & ~ & ~ & 59.535 \\ \hline 
    \end{tabular}}
...
\subsection{Análisis del impacto de apliciar la \textbf{transformada}}
...
\begin{table}[!h]
    \resizebox{\textwidth}{!}{\begin{tabular}{|c|cccc|cccc|}
        ...
        Decision Tree & 56.963 & 58.889 & 58.244 & 67.224 & 56.963 & 58.889 & 58.244 & 67.224 \\ \hline
        \textit{Average} & ~ & ~ & ~ & 64.530 & ~ & ~ & ~ & 61.790 \\ \hline
        \end{tabular}}
...
\begin{table}[!h]
    \resizebox{\textwidth}{!}{\begin{tabular}{|c|cccc|cccc|}
        ...
        \textit{Average} & ~ & ~ & ~ & 58.866 & ~ & ~ & ~ & 64.530 \\ \hline
        \end{tabular}} 
